...
@property (nonatomic, strong) AVAudioRecorder *recorder;//录音设备
@property (nonatomic, strong) AVAudioRecorder *monitor;//监听设备
@property (nonatomic, strong) NSURL *recordURL;//录音文件URL
@property (nonatomic, strong) NSURL *monitorURL;//监听器URL
